...
bool promptBet()
{
	...
	while(!validInput){
		...
		while(!validInput){
			...
			cin>>betTemp;
			cout<<endl;
			if(betTemp >= 1 && betTemp <= bankroll){
				validInput = true;
			}
			else{
				cout<<"That was not a valid amount to bet."<<endl;
			}
	...
	void spinTheWheel()
	{
		...
		cout<<endl<<"The Winning Number Is: "<<luckyNumber<<"!";
		if(luckyNumber == 1 ||
			luckyNumber == 3 ||
			luckyNumber == 5 ||
			luckyNumber == 7 ||
	...
	void determineWinnings() 
	{
		for (int i = 1; i <= numberOfValidBets; i++)
		{
			int bet = bets[i];
	...
	void getRetry()
	{
		...
		while (validInput == false){
			...
			if(bankroll >= 1){
				cout<<"Would you like to continue playing?(Enter Y or N)"<<endl<<endl;
				cin>>answer;
			}
			else
			{
			...
			if(answer == 'y' || answer == 'Y' || answer == 'n' || answer == 'N'){
				...
				if(answer == 'y' || answer == 'Y'){
					...
					cout<<"Thank you for playing Roulette"<<endl<<endl;
					if(startingBankroll>bankroll){
						cout<<"Your net loss was: $"<<startingBankroll - bankroll<<endl;
						cout<<"(You are $"<<startingBankroll - bankroll<<" poorer than when you started!)"<<endl;
					}
					else if(bankroll>startingBankroll){
						cout<<"Your net gain was: $"<<bankroll - startingBankroll<<endl;
						cout<<"(You are $"<<bankroll - startingBankroll<<" richer than when you started!)"<<endl<<endl;
					}
					else if(bankroll == startingBankroll){
						cout<<"You had no profit or loss! You broke even!"<<endl<<endl;
					}
				}
			}
